...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        if (customEffect.IsActive())
        {
            ...
            material.SetFloat(Shader.PropertyToID("_DistortionAmount"), Mathf.Lerp(0,customEffect.DistortionAmount.value,customEffect.intensity.value));
            material.SetFloat(Shader.PropertyToID("_NoiseSpeed"), Mathf.Lerp(0,customEffect.NoiseSpeed.value,customEffect.intensity.value));
